    ...
    public function checkdbAction()
    {
        ...
        if(! $oRequest->isPost()) {
            ...
            return new ViewModel([
                ...
                'sVendor' => 'oneplace',
                'sModule' => 'oneplace-import',
            ]);
        } else {
            $sSetupConfig = $oRequest->getPost('plc_module_setup_config');

            $sSetupFile = 'vendor/oneplace/oneplace-import/data/install.sql';
            ...
            if($sSetupConfig != '') {
                $sConfigStruct = 'vendor/oneplace/oneplace-import/data/structure_'.$sSetupConfig.'.sql';
                ...
                $sConfigData = 'vendor/oneplace/oneplace-import/data/data_'.$sSetupConfig.'.sql';
            ...
            $oModTbl->insert([
                'module_key'=>'oneplace-import',
                'type'=>'module',
                'version'=>\OnePlace\Import\Module::VERSION,
                'label'=>'onePlace Import',
                'vendor'=>'oneplace',
            ]);
            ...
            $this->flashMessenger()->addSuccessMessage('Import DB Update successful');
