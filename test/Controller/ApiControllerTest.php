...
use OnePlace\Import\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/import/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('import-api');
    }
}
