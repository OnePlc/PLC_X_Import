<?php
/**
 * ImportControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Import Module
 *
 * @category Test
 * @package Import
...
namespace OnePlaceTest\Import\Controller;

use OnePlace\Import\Controller\ImportController;
...
class ImportControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/import', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('import');
        $this->assertControllerName(ImportController::class); // as specified in router's controller name alias
        $this->assertControllerClass('ImportController');
        $this->assertMatchedRouteName('import');
    }
    ...
    public function testEditActionCanBeAccessed() {
        ...
        $this->dispatch('/import/edit/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('import');
        $this->assertControllerName(ImportController::class); // as specified in router's controller name alias
        $this->assertControllerClass('ImportController');
    ...
    public function testViewActionCanBeAccessed() {
        ...
        $this->dispatch('/import/view/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('import');
        $this->assertControllerName(ImportController::class); // as specified in router's controller name alias
        $this->assertControllerClass('ImportController');
